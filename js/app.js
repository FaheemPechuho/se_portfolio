(() => {
    ...
    function animateCascadeSlide() {
     ...
     // Define a function for the marquee effect
  function initMarquee() {
    const marquee = document.querySelector(".marquee");
    const marqueeText = marquee.querySelector(".marquee-text");
    
    // Clone the text elements to create a seamless scroll
    marquee.appendChild(marqueeText.cloneNode(true));
    marquee.appendChild(marqueeText.cloneNode(true));
  }
...
//         const branch = title.nextElementSibling;
//         branch.classList.toggle("show");
